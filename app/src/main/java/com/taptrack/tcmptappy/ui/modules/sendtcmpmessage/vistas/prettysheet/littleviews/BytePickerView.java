...
public class BytePickerView extends NumberPicker {
    /**
     * This is used so I dont scan the xml three times
     * technically, just changing the 4 attribute constructor
     * would also work, but that would break if the AOSP implementation
     * is changed
     */
