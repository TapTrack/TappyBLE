...
public class ActiveTappyPersistenceContract implements BaseColumns {
    public static final String TABLE_NAME = "activetappies";
    private static final String PREFIX = "acttpy_";
