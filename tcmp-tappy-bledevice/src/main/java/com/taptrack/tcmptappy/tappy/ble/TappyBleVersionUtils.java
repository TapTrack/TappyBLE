...
public class TappyBleVersionUtils {
    ...
    public static List<com.taptrack.tcmptappy.tappyblescanner.ScanFilter> getCompatScanFilter() {
        com.taptrack.tcmptappy.tappyblescanner.ScanFilter.Builder builder =
                new com.taptrack.tcmptappy.tappyblescanner.ScanFilter.Builder();
        builder.setServiceUuid(new ParcelUuid(TappyVersions.VersionOne.TRUCONNECT_SERVICE_UUID));
        List<com.taptrack.tcmptappy.tappyblescanner.ScanFilter> list = new ArrayList<com.taptrack.tcmptappy.tappyblescanner.ScanFilter>(1);
